 ...
 */
/**
 * Per-key merge: the seed wins only where the saved value is untouched.
 * `snapshot` is the seed block this payload was last reconciled against, so a
 * value that still equals it was never edited and is safe to refresh.
 */
