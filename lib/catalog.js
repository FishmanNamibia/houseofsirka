 ...
 *
 * normalizeStore merges a saved store over the seed, which means updated seed
 * copy would otherwise stay invisible to anyone with an existing localStorage
 * payload. When the stored version is behind, the content block is taken from
 * the seed again. Products, orders, customers and settings are never touched —
 * only the marketing copy resets.
 */
...
export const initialStore = {
  ...
  content: {
    announcement: "Free delivery in Windhoek over N$1,500 · eWallet, EFT and PayToday accepted",
