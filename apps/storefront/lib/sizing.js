...
const BY_CATEGORY = {
  ...
  Intimates: {
    ...
    fit: "Cut close. If you are between sizes, take the larger.",
    fabric: "Combed cotton or stretch jersey, depending on the piece.",
    stretch: "Generous",
    model: "Our model is 1.70m and wears a size S.",
  },
  Trousers: {
    ...
    fit: "Sits at the natural waist. Hemming is complimentary at the workroom.",
    fabric: "Stretch twill or ponte, depending on the piece.",
    stretch: "Slight",
    model: "Our model is 1.74m and wears a size S.",
  },
  Knitwear: {
    ...
    fit: "Relaxed through the body with a dropped shoulder.",
    fabric: "Merino or cotton knit, depending on the piece.",
    stretch: "Generous",
    model: "Our model is 1.72m and wears a size S.",
  },
  Tops: {
